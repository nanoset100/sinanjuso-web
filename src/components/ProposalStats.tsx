...
export default function ProposalStats() {
  const [stats, setStats] = useState<Stats>({ total: 0, reflected: 0, thisMonth: 0 });
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(q, (snapshot) => {
      ...
      let reflected = 0, thisMonthCount = 0;
      ...
      setStats({ total: snapshot.size, reflected, thisMonth: thisMonthCount });
    });
    return () => unsub();
  }, []);
